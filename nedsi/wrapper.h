...
// MISC layout
#define ________________MISC_L1________________     _______, _______, _______, _______, QK_BOOT
#define ________________MISC_L2________________     _______, _______, C(KC_C), C(KC_V), _______
...
#define ________________MISC_R3________________     _______, KC_MPLY, _______, _______, _______
